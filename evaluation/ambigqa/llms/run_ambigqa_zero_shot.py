...
if __name__ == "__main__":
        ...
        for index, row in enumerate(raw_data):
                ...
                user_prompt = """Think step by step and generate all possible and applicable. Start the set of answers with [Final Answer]: separated by newline for the Question:"""+row.question.text()
