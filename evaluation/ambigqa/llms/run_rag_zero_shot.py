...
if __name__ == "__main__":
        ...
        for index, row in enumerate(raw_data):
                ...
                user_prompt = """given a question and relevant evidence use information from evidence Evidence:"""+top_3+""" and Think step by step, generate rationale preceded by rationale: and generate all possible and applicable preceded by [Final Answer]: for the Question:"""+row.question.text()
                ...
                final_questions.to_csv("chatgpt_rag_ambigqa_zero_shot_cot_10.tsv",sep="\t",index=False)
        print("F1", f1/len(ids))
