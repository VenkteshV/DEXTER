...
[Final Answer]:51
                Following the give examples, Think step by step, use information from given table and text"""+"Table and Text:"+evidence_text +"and answer the Question:""" +row.question.text() +"Give only the answer preceded by [Final Answer]:"
                ...
                evidences = []
                final_questions.to_csv("llama2_tatqa_few_cot.tsv",sep="\t",index=False)
