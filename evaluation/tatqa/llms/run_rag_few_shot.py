...
if __name__=="__main__":
        ...
        system_prompt = "Following the examples, Given the question, table and text think step by step decompose it and use information in table and text, output final answer for the question and give answer in form of  [Final Answer]: \n"
        matches = 0
        mismatches = 0
        ids = []
        for row in raw_data:
                ...
                user_prompt = """Text: during the year ended march 31 , 2012 , the company has recorded $ 3.3 million in stock-based compensation expense for equity awards in which the prescribed performance milestones have been achieved or are probable of being achieved .
...
[Final Answer]:51
                Following the examples, Think step by step, use information from given table and text and give answer preceded by [Final Answer]: for the Question:"""+top_3 +row.question.text()
                ...
                final_questions.to_csv("chatgpt_tatqa_rag_10_few_shot.tsv",sep="\t",index=False)
