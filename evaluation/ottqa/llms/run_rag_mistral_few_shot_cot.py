...
if __name__=="__main__":
    ...
    [Final Answer]:51 \n
                    Following the give examples, Think step by step, use information from given table and text"""+"Table and Text:"+evidence_text +"and answer the Question:""" +row.question.text() +"Give answer for the question using relevant information from table and text preceded by [Final Answer]:"
...
Rationale: The ending allowance balance in 2005 is 47. The ending allowance balance in 2004 is 49. The ending allowance balance in 2003 is 51. The highest ending allowance balance is 51. So the answer is 51.
[Final Answer]:51
                Following the give examples, Think step by step, use information from given table and text"""+"Table and Text:"+evidence_text +"and answer the Question:""" +row.question.text()+"Give answer preceded by [Final Answer]:"
                # print("user_prompt",user_prompt)
                chain_answer = llm_instance.get_mistral_completion(system_prompt, user_prompt)
                ...
                evidences = []
                final_questions.to_csv("mistral_ottqa_few_cot.tsv",sep="\t",index=False)
