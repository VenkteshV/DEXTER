...
if __name__=="__main__":
        ...
        for index,row in enumerate(raw_data):
                ...
                user_prompt =  "Think step by step and Given the evidence, Evidence: "+evidence_text+" \n use the information and answer the Question:"+row.question.text()
                ...
                final_questions.to_csv("chatgpt_wikimultihop_rag_oracle_zero_shot.tsv",sep="\t",index=False)
