...
[Final Answer]: February 4, 1948.\n\n """ + "Follow the above example, think step by step and Given the evidence, Evidence: "+evidence_text+" \n use the information and answer the Question:"+row.question.text()
                ...
                final_questions.to_csv("chatgpt_wikimultihop_rag_oracle_few_cot.tsv",sep="\t",index=False)
