...
class SPLADE(BaseRetriver):
    ...
    def load_index_if_available(self,data_name: str)->Tuple[Any,bool]:
        if os.path.exists("indices/corpus/splade_index_{}".format(data_name)):
            corpus_embeddings = joblib.load("indices/corpus/splade_index_{}".format(data_name))
            index_present=True
        else:
            index_present = False
    ...
    def retrieve(self, 
        ...
        embeddings, index_present = self.load_index_if_available(data_name)
        ...
        if index_present:
            ...
            if not os.path.exists("indices"):
                os.makedirs("indices")
            if not os.path.exists("indices/corpus"):
                os.makedirs("indices/corpus")
            joblib.dump(corpus_embeddings,"indices/corpus/splade_index_{}".format(data_name))
