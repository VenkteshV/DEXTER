...
loader = AmbigQADataLoader("ambignq-light", config_path="tests/data/loaders/test_config.ini", split=Split.DEV, batch_size=10)



ret_results = json.load(open("/home/venky/ambigqa/codes/out/dpr/dev_20200201_predictions_1.json"))
...
data_path = "/home/venky/ambigqa/codes/dpr_data_dir/data/wikipedia_split/psgs_w100_20200201.tsv.gz"

k = json.load(open('data/wikidata.json'))
passages,titles = k['passages'], k['titles']
#passages, titles = load_db(data_path=data_path,subset=ids)

# json.dump({'passages':passages,'titles':titles},open('data/wikidata.json','w+'))
...
json.dump(tokenized_data,open("data/dpr_tokenized.json","w+"))
...
reader = ReaderFactory().create_reader(
    ...
    checkpoint="/home/venky/ambigqa/codes/out/ambignq-span-selection/best-model.pt",
)
reader.eval()                  
