...
For components in retrieval we draw inspiration from BEIR (https://github.com/beir-cellar/beir) and reuse parts of implementation. We thank the authors for open-sourcing their code.
